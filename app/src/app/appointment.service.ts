...
export class AppointmentService {
  ...
  aboutyouapi(langarr:Array<just>,actarr:Array<just>,staticc:Array<just>,illness: string,yeari: string,remark: string,phy: string,ach: string,legal: string): Observable<Aboutyou> {
    return this.http.post<Aboutyou>(`${this.BASE_URL}/abb`, { langarr, actarr,staticc, illness, yeari, remark, phy, ach, legal});
  }
